...
Вы дадите пользователю возможность входа и выхода из системы, которая позволит дать ему выполнять более разрушительные действия, такие как редактирование и удаление (что может быть делегировано только администратору). До этих "опасных" действий дело дойдет в главе 9 Учебника.
