...
Вы узнали(по крайней мер, должны были), как работает сеть в уроке [Как работает сеть](/web-development-101/how-does-the-web-work) из курса [Основы веб-разработки](/web-development-101), но, возможно, стоит вернуться назад, освежить память, если что-то позабылось. В этом разделе вы поработаете с HTTP-запросами и ответами, так что важно по меньшей мере понимать, что здесь происходит.
