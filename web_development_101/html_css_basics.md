...
Как вы, надеемся, [узнали ранее](http://skillcrush.com/2012/06/24/html-2/), HTML является разметкой, которая содержит в себе все, что вы видите на веб-страницее. Весь текст на этой странице сейчас находится внутри HTML-тегов, которые говорят вашему браузеру, как его упорядочить. Давайте, кликните правой кнопкой на любой элемент на странице и выберите "Проверить объект" (или похожую опцию), чтобы открыть Инструменты разработчика вашего браузера и вы увидите структуру страницы.
